    ...
    <div class="page">
      ...
      <section class="section section-sm section-first bg-default text-md-left">
        <div class="container">
          ...
          <div class="group-sm group-middle">
            <div class="button button-lg button-primary button-pipaluk">Large size</div>
            <div class="button button-primary button-pipaluk">Default size</div>
            <div class="button button-md button-primary button-pipaluk">Medium size</div>
          </div>
        </div>
      </section>
      <!-- Button Shapes-->
      <section class="section section-sm bg-default text-md-left">
        <div class="container">
          <h3>Button Shapes</h3>
          <div class="group-sm group-middle">
            <div class="button button-primary button-pipaluk">Square</div>
            <div class="button button-primary button-pipaluk button-circle">Circle</div>
          </div>
        </div>
      </section>
      <!-- Buttons with Icons-->
      <section class="section section-sm section-last bg-default text-md-left">
        <div class="container">
          ...
          <div class="group-sm group-middle">
            <div class="button button-icon button-icon-left button-primary button-pipaluk"><span class="icon fa fa-plus"></span>Add to cart</div>
            <div class="button button-icon button-icon-left button-default-outline button-wapasha"><span class="icon fa fa-plus"></span>Add to cart</div>
          </div>
        </div>
      </section>
      <!-- Page Footer-->
