      ...
      <section class="section section-xl bg-default text-center">
        <div class="container isotope-wrap">
          <div class="isotope-filters isotope-filters-horizontal">
            <button class="isotope-filters-toggle button button-md button-icon button-icon-right button-default-outline button-wapasha" data-custom-toggle="#isotope-1" data-custom-toggle-hide-on-blur="true" data-custom-toggle-disable-on-blur="true"><span class="icon fa fa-caret-down"></span><span>Filter</span></button>
            <ul class="isotope-filters-list" id="isotope-1">
              <li><a class="active" href="#" data-isotope-filter="*">All</a></li>
              <li><a href="#" data-isotope-filter="Type 1">Apartments</a></li>
              <li><a href="#" data-isotope-filter="Type 2">Offices</a></li>
              <li><a href="#" data-isotope-filter="Type 3">Corporate designs</a></li>
            </ul>
          </div>
          <div class="row row-50 isotope" data-lightgallery="group">
            ...
            <div class="col-md-6 col-lg-4 isotope-item" data-filter="Type 3">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-4-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">McMillan’s House</a></h5>
                  <p class="thumbnail-modern-subtitle">2012, Residential Project, Denmark</p>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-4 isotope-item" data-filter="Type 2">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-5-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">Modern luxury hotel</a></h5>
                  <p class="thumbnail-modern-subtitle">2011, Custom Project, UK</p>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-4 isotope-item" data-filter="Type 1">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-6-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-6-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">Weilround entertainment center</a></h5>
                  <p class="thumbnail-modern-subtitle">2009, Custom Project, Switzerland</p>
                </div>
              </article>
            </div>
          </div>
