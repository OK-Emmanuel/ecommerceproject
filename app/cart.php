                                            ...
                                            <table class="table table-bordered table-vcenter">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="text-center">
                                                                <img src="assets/images/products/3.jpg" alt="" class="cart-img text-center">
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-center">
                                                                <img src="assets/images/products/7.jpg" alt="" class="cart-img">
                                                            </div>
                                                        </td>
                                                        <td>laborum et dolorum fuga</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-center">
                                                                <img src="assets/images/products/9.jpg" alt="" class="cart-img">
                                                            </div>
                                                        </td>
                                                        <td>laborum et dolorum fuga</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-center">
                                                                <img src="assets/images/products/8.jpg" alt="" class="cart-img">
                                                            </div>
                                                        </td>
                                                        <td>laborum et dolorum fuga</td>
                                                        <td class="fw-bold">$1,027</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-center">
                                                                <img src="assets/images/products/5.jpg" alt="" class="cart-img">
                                                            </div>
                                                        </td>
                                                        <td>laborum et dolorum fuga</td>
                                                        <td class="fw-bold">$1,589</td>
