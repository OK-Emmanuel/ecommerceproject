                                            ...
                                            <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom-0">Descrption</th>
                                                        ...
                                                        <th class="border-bottom-0">Cover Photo</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php 
...
?>  
                                                    <tr>
                                                        ...
                                                        <td><img src="../photo/<?php echo $row['photo']; ?>" alt="" style="height: 60px;"></td>

                                                        <td><img src="coverphoto/<?php echo $row['coverphoto']; ?>" alt="" style="height: 60px;"></td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="editprofile.php?uin=<?php echo $row['uin'];?>">Edit Product</a>
                                                            <a class="dropdown-item" href="deleteproduct.php?id=<?php echo $row['id']; ?>" onclick= "return confirm('Do you want to delete this record?')">Delete</a>
