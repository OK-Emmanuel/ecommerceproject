            ...
            <div>
              ...
              <form class="rd-form rd-mailform rd-form-inline rd-form-coupon">
                ...
                <div class="form-button">
                  <button class="button button-primary button-pipaluk" type="submit">Apply coupon</button>
                </div> -->
           
            </div>
            <div>
              <div class="group-xmd group-middle" style="margin-left: 770px; margin-top: -40px;">
                <div >
                  <div class="group-xmd group-middle">
                    <h6 class="text-gray-500">Total Amount</h6>
                    <h3 class="cart-product-price"><sup>$</sup><?php echo number_format($carttotal, 2); ?></h3>
                  </div>
                </div><a class="button button-secondary button-pipaluk" href="checkout.php?user_id=<?php echo $_SESSION['user_id']; ?>" style="margin-top: -10px; margin-left: 55px;">Proceed to checkout</a>
              </div>
            </div>
          </div>
        </div> 
