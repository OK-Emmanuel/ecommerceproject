    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-68">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Services #2</h2>
          ...
          <div class="box-position" style="background-image: url(images/bg-services.jpg);"></div>
        </div>
      </section>
      <!-- Section-services-->
        ...
        <div class="container">
          <div class="row row-50 justify-content-center box-ordered">
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-1-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Interior design</a></h5>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-2-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Space planning</a></h5>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-3-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Feng shui design</a></h5>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-4-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Consultations</a></h5>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-5-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Decorative services</a></h5>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Services Classic-->
              <article class="services-classic"><a class="services-classic-figure" href="single-service.html"><img src="images/services-6-370x297.jpg" alt="" width="370" height="297"></a>
                <div class="services-classic-caption">
                  <h4 class="services-classic-counter box-ordered-item"></h4>
                  <h5 class="services-classic-title"><a href="single-service.html">Landscape design</a></h5>
                </div>
              </article>
            </div>
          </div>
