    ...
    <div class="page">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="../index.html"><img src="images/logo-default-190x43.png" alt="" width="190" height="43"></a></div>
                </div>
                    ...
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item"><a class="rd-nav-link" href="../index.html">Home</a>
                        ...
                        <ul class="rd-menu rd-navbar-dropdown">
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="interior-design.html">Interior design</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="decor.html">Decor</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="index.html">Feng Shui</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="landscaping.html">Landscaping</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="flooring.html">Flooring</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="furniture.html">Furniture</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="windows-and-doors.html">Windows and Doors</a></li>
                        </ul>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="about-us.html">About Us</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="grid-gallery.html">Portfolio</a>
                        <!-- RD Navbar Dropdown-->
                        <ul class="rd-menu rd-navbar-dropdown">
                          ...
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-project-2.html">Single Project 2</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-project-3.html">Single Project 3</a></li>
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-project-4.html">Single Project 4</a></li>
                        </ul>
                      </li>
                        ...
                        <ul class="rd-menu rd-navbar-megamenu">
                          ...
                          <li class="rd-megamenu-item rd-megamenu-carousel">
                            <div>
                              ...
                              <!-- Owl Carousel-->
                              <div class="owl-carousel owl-navbar" data-items="1" data-xl-items="2" data-xxl-items="3" data-margin="16" data-dots="true">
                                <!-- Thumbnail Classic-->
                                ...
                                <article class="thumbnail thumbnail-mary thumbnail-xxs">
                                  ...
                                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-gallery-8-1200x800-original.jpg" data-lightgallery="item"><img src="images/navbar-4-272x288.jpg" alt="" width="272" height="288"></a>
                                ...
                                <article class="thumbnail thumbnail-mary thumbnail-xxs">
                                  ...
                                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-masonry-gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="images/navbar-5-272x288.jpg" alt="" width="272" height="288"></a>
                                ...
                                <article class="thumbnail thumbnail-mary thumbnail-xxs">
                                  ...
                                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="images/navbar-6-272x288.jpg" alt="" width="272" height="288"></a>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-39">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Hover effects</h2>
          ...
          <div class="box-position" style="background-image: url(images/bg-hover-effects.jpg);"></div>
        </div>
      </section>
      <!-- Section hover #1-->
        ...
        <div class="container">
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Thumbnail Classic-->
              <article class="thumbnail thumbnail-classic thumbnail-sm">
                <div class="thumbnail-classic-figure"><img src="images/hover-effects-1-370x303.jpg" alt="" width="370" height="303">
                </div>
                <div class="thumbnail-classic-caption">
                  <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-gallery-2-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-1-370x303.jpg" alt="" width="370" height="303"></a>
            ...
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Thumbnail Classic-->
              <article class="thumbnail thumbnail-classic thumbnail-sm">
                <div class="thumbnail-classic-figure"><img src="images/hover-effects-2-370x303.jpg" alt="" width="370" height="303">
                </div>
                <div class="thumbnail-classic-caption">
                  <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="images/hover-effects-2-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-2-370x303.jpg" alt="" width="370" height="303"></a>
            ...
            <div class="col-md-6 col-lg-5 col-xl-4">
              <!-- Thumbnail Classic-->
              <article class="thumbnail thumbnail-classic thumbnail-sm">
                <div class="thumbnail-classic-figure"><img src="images/hover-effects-3-370x303.jpg" alt="" width="370" height="303">
                </div>
                <div class="thumbnail-classic-caption">
                  <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="images/hover-effects-3-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-3-370x303.jpg" alt="" width="370" height="303"></a>
        ...
        <div class="container">
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-md-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-1-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">Modern loft room</a></h5>
                  <p class="thumbnail-modern-subtitle">2013, Commercial, Denmark</p>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-2-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-2-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">Asia inspired living room</a></h5>
                  <p class="thumbnail-modern-subtitle">2015, Residential Project, Denmark</p>
                </div>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-modern"><a class="thumbnail-modern-figure" href="images/grid-gallery-3-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-3-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-modern-caption">
                  <h5 class="thumbnail-modern-title"><a href="single-project.html">Sunny valley hotel</a></h5>
                  <p class="thumbnail-modern-subtitle">2013, Custom Project, Spain</p>
                </div>
              </article>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-sm-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-creative thumbnail-sm"><a class="thumbnail-creative-figure" href="images/hover-effects-7-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-7-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-creative-caption">
                  <h5 class="thumbnail-creative-title"><a href="single-project.html">White inn</a></h5>
            ...
            <div class="col-sm-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-creative thumbnail-sm"><a class="thumbnail-creative-figure" href="images/hover-effects-8-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-8-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-creative-caption">
                  <h5 class="thumbnail-creative-title"><a href="single-project.html">Small kitchen</a></h5>
                  <div class="thumbnail-creative-time">
                    <time datetime="2015-12-05">December 05, 2015</time>
                  </div>
                  <div class="thumbnail-creative-button"><a class="button button-md button-white" href="#">Read more</a></div>
                </div>
              </article>
            ...
            <div class="col-sm-6 col-lg-4">
              <!-- Thumbnail Modern-->
              <article class="thumbnail thumbnail-creative thumbnail-sm"><a class="thumbnail-creative-figure" href="images/hover-effects-3-1200x800-original.jpg" data-lightgallery="item"><img src="images/hover-effects-3-370x303.jpg" alt="" width="370" height="303"></a>
                <div class="thumbnail-creative-caption">
                  <h5 class="thumbnail-creative-title"><a href="single-project.html">Smith center</a></h5>
                  <div class="thumbnail-creative-time">
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-md-6 col-lg-4">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-sm">
                ...
                <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-8-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-8-370x303.jpg" alt="" width="370" height="303"></a>
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-sm">
                ...
                <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-7-370x303.jpg" alt="" width="370" height="303"></a>
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-sm">
                ...
                <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-9-1200x800-original.jpg" data-lightgallery="item"><img src="images/grid-gallery-9-370x303.jpg" alt="" width="370" height="303"></a>
