...
?> 
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    <div class="product-figure"><img src="app/catimage/<?php echo $row['catimage']; ?>" alt="" style="height:400px;"> 
                    
                               
                    
                      <div class="product-button"><a class="button button-md button-white button-ujarak" href="shop.php?name=<?php echo $row['name']; ?>">View Product</a></div>
                    </div>
                    <h5 class="product-title"><a href="category.php?name=<?php echo $row ['name'];?>"><?php echo $row['name']; ?></a></h5>
                  
                    <div class="product-price-wrap">
                      <div class="product-price"><?php echo $row['catdescription']; ?></div>
                    </div>
                  </article>
                </div><?php }} ?>
              </div>
                  ...
                  <ul class="list list-shop-filter">
                    <li>
                      <label class="checkbox-inline">
                        <a href=""><input name="input-group-radio" value="checkbox-1" type="checkbox">Chairs</a>
...
?> 
                      <!-- Product Minimal-->
                      <article class="product">
                    <div class="product-figure"><img src="app/catimage/<?php echo $row['catimage']; ?>" alt="" width="270" style="height:400px;"> 
                    
                               
                    
                      <div class="product-button"><a class="button button-md button-white button-ujarak" href="category.php?name=<?php echo $row['name']; ?>">View Product</a></div>
                    </div>
                    <h5 class="product-title"><a href="category.php?name=<?php echo $row ['name'];?>"><?php echo $row['name']; ?></a></h5>
