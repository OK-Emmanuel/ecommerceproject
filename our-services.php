    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="faq.php">FAQ</a>
                        <!-- RD Navbar Megamenu-->
                      </li>
                    </ul>
                  </div>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-64">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Interior design</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.php">Home</a></li>
              <li class="active">Interior design</li>
            </ul>
          </div>
          <div class="box-position" style="background-image: url(images/bg-single-service.jpg);"></div>
        </div>
      </section>
          ...
          <div class="row row-70">
            <div class="col-lg-8">
              <div class="single-service">
                <h3>Designing your interior</h3>
                <p class="text-spacing-100">Powerful interior spaces make a difference in our lives. These spaces are where we come to work, heal, learn and live. Creator is always ready to help you improve their look.</p>
                <!-- Quote Classic-->
                <article class="quote-classic">
                  <div class="quote-classic-text">
                    <p class="q">Our Interior Design services combine creativity, passion, research and expertise to deliver breathtaking spaces.</p>
                  </div>
                </article>
                <p class="text-spacing-100">Across every market we serve, our team designs thoughtful interior environments by engaging key stakeholders through proprietary and proven processes to enhance culture and achieve goals. Our work never loses focus on the human experience of space and we are committed to achieving design solutions that enrich lives and empower individuals.</p>
                <div class="row row-40 align-items-xl-center">
                  <div class="col-md-6 col-xl-5">
                    <h5 class="text-spacing-100">key features</h5>
                    <ul class="list-sm list-marked list-marked-sm list-marked-secondary text-spacing-100">
                      <li>Photorealistic 3D visualisation</li>
                      <li>Sketches and collages</li>
                      <li>The final planning decision</li>
                      <li>Interior substantive content</li>
                    </ul><a class="button button-primary button-pipaluk" href="#">Get a free quote</a>
                  </div>
                  <div class="col-md-6 col-xl-7 text-lg-right"><img src="images/single-service-1-418x289.jpg" alt="" width="418" height="289">
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="post-sidebar-item">
                      ...
                      <div class="post-sidebar-item-inset inset-right-20">
                        <ul class="list list-categories">
                          <li><a class="active" href="#">Interior Design</a></li>
                          <li><a href="#">Space Planning</a></li>
                          <li><a href="#">Fengshui Design</a></li>
                        ...
                        <ul class="list-contacts">
                          ...
                          <li>
                            <div class="unit unit-spacing-xs">
                              ...
                              <div class="unit-body"><a class="link-email" href="mailto:#">info@demolink.org</a></div>
                            </div>
                          </li>
                          <li>
                            <div class="unit unit-spacing-xs">
          ...
          <div class="row row-30 row-sm justify-content-center box-ordered">
            <div class="col-sm-6 col-md-5 col-lg-3">
              <article class="box-icon-leah">
                ...
                <h5 class="box-icon-leah-title"><a href="single-service.php">Free consultation</a></h5>
                <p class="box-icon-leah-text">Everything begins with the initial consultation offered by our designers.</p>
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              <article class="box-icon-leah">
                ...
                <h5 class="box-icon-leah-title"><a href="single-service.php">Concept creation</a></h5>
                <p class="box-icon-leah-text">During this stage, our designers create the concept of your interior.</p>
                <div class="box-icon-leah-count box-ordered-item"></div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              <article class="box-icon-leah">
                ...
                <h5 class="box-icon-leah-title"><a href="single-service.php">3d modeling</a></h5>
                <p class="box-icon-leah-text">To demonstrate how the result will look like, we use detailed 3D modeling.</p>
                <div class="box-icon-leah-count box-ordered-item"></div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              <article class="box-icon-leah">
                <div class="box-icon-leah-icon fl-bigmug-line-paintbrush9"></div>
                <h5 class="box-icon-leah-title"><a href="single-service.php">Interior Remodeling</a></h5>
                <p class="box-icon-leah-text">During this stage, we work to transform your interior according to the project.</p>
                <div class="box-icon-leah-count box-ordered-item"></div>
              </article>
            </div>
          </div>
      ...
      <section class="section section-sm section-fluid bg-default">
        ...
        <!-- Owl Carousel-->
        <div class="owl-carousel owl-classic" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="4" data-margin="30" data-nav="true" data-dots="true">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-1-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #1</a></h5>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-masonry-gallery-10-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-2-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #2</a></h5>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/grid-gallery-3-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-3-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #3</a></h5>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/project-4-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-4-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #4</a></h5>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/fullwidth-gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-5-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #5</a></h5>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary thumbnail-md">
            ...
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/project-6-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-6-420x308.jpg" alt="" width="420" height="308"></a>
              <h5 class="thumbnail-mary-title"><a href="single-project.php">Project #6</a></h5>
            </div>
          </article>
        </div>
      </section>
              ...
              <div class="box-pricing">
                <div class="box-pricing-body">
                  <div class="box-pricing-caption">
                    ...
                    <h3 class="box-pricing-price">$9.00</h3>
                    <div class="box-pricing-time">Per Month</div>
                  </div>
                  <div class="divider divider-35"></div>
                  <ul class="box-pricing-list">
                    <li class="active">Concept development</li>
                    <li class="active">Photorealistic 3D visualisation</li>
                    <li>Sketches and elevations</li>
                    <li>Space planning</li>
                    <li>Decorative services</li>
                  </ul>
                </div>
              ...
              <div class="box-pricing box-pricing-popular">
                <div class="box-pricing-body">
                  <div class="box-pricing-caption">
                    ...
                    <h3 class="box-pricing-price">$19.99</h3>
                    <div class="box-pricing-time">Per Month</div>
                  </div>
                  <div class="divider divider-35"></div>
                  <ul class="box-pricing-list">
                    <li class="active">Concept development</li>
                    <li class="active">Photorealistic 3D visualisation</li>
                    <li class="active">Sketches and elevations</li>
                    <li class="active">Space planning</li>
                    <li>Decorative services</li>
                  </ul>
                </div>
              ...
              <div class="box-pricing">
                <div class="box-pricing-body">
                  <div class="box-pricing-caption">
                    ...
                    <h3 class="box-pricing-price">$30.00</h3>
                    <div class="box-pricing-time">Per Month</div>
                  </div>
                  <div class="divider divider-35"></div>
                  <ul class="box-pricing-list">
                    ...
                    <li class="active">Sketches and elevations</li>
                    <li class="active">Space planning</li>
                    <li class="active">Decorative services</li>
                  </ul>
                </div>
                <div class="box-pricing-button"><a class="button button-lg button-block button-gray-4" href="#">Get started</a></div>
              </div>
