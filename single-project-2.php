    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="grid-gallery.html">Portfolio</a>
                        <!-- RD Navbar Dropdown-->
                        <ul class="rd-menu rd-navbar-dropdown">
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-46">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Single project 2</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="../index.html">Home</a></li>
              <li><a href="grid-gallery.html">Portfolio</a></li>
              <li class="active">Single project 2</li>
            </ul>
          </div>
          <div class="box-position" style="background-image: url(images/bg-single-project.jpg);"></div>
        </div>
      </section>
      <!-- Single Project-->
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInLeft" data-wow-delay="0s"><a class="thumbnail-joan-figure" href="images/fullwidth-gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-13-370x315.jpg" alt="" width="370" height="315"></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInUp" data-wow-delay=".1s"><a class="thumbnail-joan-figure" href="images/fullwidth-masonry-gallery-7-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-14-370x315.jpg" alt="" width="370" height="315"></a>
                  <div class="thumbnail-joan-caption">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInRight" data-wow-delay=".0s"><a class="thumbnail-joan-figure" href="images/fullwidth-gallery-7-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-15-370x315.jpg" alt="" width="370" height="315"></a>
                  <div class="thumbnail-joan-caption">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInUp" data-wow-delay=".1s"><a class="thumbnail-joan-figure" href="images/grid-gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-16-370x315.jpg" alt="" width="370" height="315"></a>
                  <div class="thumbnail-joan-caption">
                    <h5 class="thumbnail-joan-title">Photo name #4</h5>
                  </div>
                </article>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInLeft" data-wow-delay="0s"><a class="thumbnail-joan-figure" href="images/project-6-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-17-370x315.jpg" alt="" width="370" height="315"></a>
                  <div class="thumbnail-joan-caption">
                    <h5 class="thumbnail-joan-title">Photo name #5</h5>
                  </div>
                </article>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Joan-->
                <article class="thumbnail thumbnail-joan thumbnail-sm wow slideInDown" data-wow-delay=".1s"><a class="thumbnail-joan-figure" href="images/fullwidth-masonry-gallery-10-1200x800-original.jpg" data-lightgallery="item"><img src="images/project-18-370x315.jpg" alt="" width="370" height="315"></a>
                  <div class="thumbnail-joan-caption">
                    <h5 class="thumbnail-joan-title">Photo name #6</h5>
                  </div>
                </article>
              </div>
            </div>
          ...
          <div class="row row-30 align-items-center">
            <div class="col-lg-8">
              <div class="single-project">
                <h4>Weilround entertainment center</h4>
                <p class="text-gray-500">This project was designed for one of the biggest Swiss entertainment centers that grew in popularity in 2009. One of their new buildings needed top quality interior designed and our studio offered the services of Will O’Brien. Everything was completed in less than a month. Our studio combined some of the best architectural and interior design achievements in this project.</p>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="single-project-aside">
                <ul class="list list-description d-inline-block d-md-block">
                  <li><span>Designer:</span><span>Will O’Brien</span></li>
                  <li><span>Year:</span><span>May 17, 2009</span></li>
                  <li><span>Location:</span><span>Bern, Switzerland</span></li>
                  <li><span>Categories:</span><span>Custom Projects</span></li>
                </ul>
              ...
              <div class="col-sm-6">
                <div class="project-minimal">
                  <div class="unit unit-spacing-lg align-items-center flex-column flex-lg-row text-lg-left">
                    <div class="unit-left"><a class="project-minimal-figure" href="single-project.html"><img src="images/project-minimal-2-168x139.jpg" alt="" width="168" height="139"></a></div>
                    <div class="unit-body">
                      <p class="project-minimal-text">2017, Commercial Project, USA</p>
                      <div class="project-minimal-title"><a href="single-project.html">Bedroom serenity redefined</a></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="project-minimal">
                  <div class="unit unit-spacing-lg align-items-center flex-column flex-lg-row-reverse text-lg-right">
                    <div class="unit-left"><a class="project-minimal-figure" href="single-project-3.html"><img src="images/project-minimal-3-168x139.jpg" alt="" width="168" height="139"></a></div>
                    <div class="unit-body">
                      <p class="project-minimal-text">2017, Commercial Project, USA</p>
                      <div class="project-minimal-title"><a href="single-project-3.html">Bedroom furniture design</a></div>
                    </div>
                  </div>
                </div>
              </div>
            </div><a class="project-navigation-arrow-prev" href="single-project.html"></a><a class="project-navigation-arrow-next" href="single-project-3.html"></a>
          </div>
        </div>
      </section>
      <!-- Page Footer-->
