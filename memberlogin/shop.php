    ...
    <div class="page">
              ...
              <div class="row row-lg row-40">
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    <div class="product-figure"><img src="images/product-1-270x280.png" alt="" width="270" height="280">
                      <div class="product-button"><a class="button button-md button-white button-ujarak" href="cart-page.php">Add to cart</a></div>
                    </div>
                    <h5 class="product-title"><a href="single-product.php">CB2 chamber desk</a></h5>
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">ÖVERUD Lamp shade</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">Round dining table</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">CB2 Coup Grey Office Chair</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">Grasshoppa floor lamp</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">Lucinda orange Chair</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">Vejmon table</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  ...
                  <article class="product">
                    ...
                    <h5 class="product-title"><a href="single-product.php">SKOGSNÄVA pillow cover</a></h5>
                    <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4">
                  <!-- Product-->
                  <article class="product">
                    <div class="product-figure"><img src="images/product-9-270x280.png" alt="" width="270" height="280">
                      <div class="product-button"><a class="button button-md button-white button-ujarak" href="cart-page.php">Add to cart</a></div>
                    </div>
                    <h5 class="product-title"><a href="single-product.php">Ikea Tertial Work lamp</a></h5>
                    <div class="product-price-wrap">
                  ...
                  <ul class="list list-shop-filter">
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-1" type="checkbox">Chairs
                  ...
                  <div class="list-popular-product">
                    <div class="list-popular-product-item">
                      ...
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.php"><img src="images/product-mini-1-108x100.png" alt="" width="108" height="100"></a></div>
                        <div class="unit-body">
                          <h6 class="product-minimal-title"><a href="single-product.php">Ikea frode chair</a></h6>
                    ...
                    <div class="list-popular-product-item">
                      <!-- Product Minimal-->
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.php"><img src="images/product-mini-2-108x100.png" alt="" width="108" height="100"></a></div>
                        <div class="unit-body">
                          <h6 class="product-minimal-title"><a href="single-product.php">Sanela cushion</a></h6>
                    ...
                    <div class="list-popular-product-item">
                      <!-- Product Minimal-->
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.php"><img src="images/product-mini-3-108x100.png" alt="" width="108" height="100"></a></div>
                        <div class="unit-body">
                          <h6 class="product-minimal-title"><a href="single-product.php">White lampshade</a></h6>
      ...
      <footer class="section section-fluid footer-classic">
          ...
          <div class="row row-30 justify-content-center">
            <div class="col-md-10 col-lg-12 col-xl-4 wow fadeInRight">
              <div class="box-footer box-footer-small">
                <div class="footer-brand"><a href="../EcommerceProject/index.php"><img src="logo.png" style="width: 130px;"></a></div>
        ...
        <div class="container footer-bottom-panel wow fadeInUp">
          <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Creator</span>. All rights reserved. <a href="privacy-policy.php">Privacy Policy</a>
          </p>
        </div>
      </footer>
    </div>
