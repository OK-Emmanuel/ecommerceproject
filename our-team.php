    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-46">
          ...
          <div class="box-position" style="background-image: url(images/bg-elements-3.jpg);"></div>
        </div>
      </section>
      <!-- Team #1-->
          ...
          <div class="row row-xs row-40 justify-content-center justify-content-lg-start">
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                ...
                <div class="team-modern-caption">
                  <h5 class="team-modern-name"><a href="#">Sam Robinson</a></h5>
                  <p class="team-modern-status">Senior Architect</p>
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                ...
                <div class="team-modern-caption">
                  <h5 class="team-modern-name"><a href="#">Sam Claflin</a></h5>
                  <p class="team-modern-status">Flooring Installer</p>
                  <h6 class="team-modern-phone"><a href="tel:#">+1 323-913-4688</a></h6>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                ...
                <div class="team-modern-caption">
                  ...
                  <p class="team-modern-status">Architect</p>
                  <h6 class="team-modern-phone"><a href="tel:#">+1 323-913-4688</a></h6>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="team-modern">
                ...
                <div class="team-modern-caption">
                  ...
                  <p class="team-modern-status">Window Installer</p>
                  <h6 class="team-modern-phone"><a href="tel:#">+1 323-913-4688</a></h6>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-6 col-lg-5 col-xl-4">
              ...
              <article class="team-creative"><a class="team-creative-figure" href="#"><img src="images/team-4-370x366.jpg" alt="" width="370" height="366"></a>
                <div class="team-creative-caption">
                  ...
                  <p class="team-creative-status">Architect</p>
        ...
        <div class="container">
          ...
          <div class="row row-30 justify-content-center justify-content-lg-start">
            <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3">
              <!-- Team Nikki-->
              <article class="team-nikki"><a class="team-nikki-figure" href="#"><img src="images/team-7-270x248.jpg" alt="" width="270" height="248"></a>
                <div class="team-nikki-caption">
                  <h5 class="team-nikki-name"><a href="#">Ann Anderson</a></h5>
                  <p class="team-nikki-status">Junior Designer</p>
            ...
            <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3">
              <!-- Team Nikki-->
              <article class="team-nikki"><a class="team-nikki-figure" href="#"><img src="images/team-8-270x248.jpg" alt="" width="270" height="248"></a>
                <div class="team-nikki-caption">
                  <h5 class="team-nikki-name"><a href="#">Sam Robinson</a></h5>
                  <p class="team-nikki-status">Senior Architect</p>
                  <div class="team-nikki-arrow"></div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3">
              <!-- Team Nikki-->
              <article class="team-nikki"><a class="team-nikki-figure" href="#"><img src="images/team-9-270x248.jpg" alt="" width="270" height="248"></a>
                <div class="team-nikki-caption">
                  <h5 class="team-nikki-name"><a href="#">Mary Lee</a></h5>
                  <p class="team-nikki-status">Decorator</p>
                  <div class="team-nikki-arrow"></div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3">
              <!-- Team Nikki-->
              <article class="team-nikki"><a class="team-nikki-figure" href="#"><img src="images/team-10-270x248.jpg" alt="" width="270" height="248"></a>
                <div class="team-nikki-caption">
                  <h5 class="team-nikki-name"><a href="#">Samuel Miller</a></h5>
                  <p class="team-nikki-status">Interior Designer</p>
                  <div class="team-nikki-arrow"></div>
                </div>
              </article>
            </div>
