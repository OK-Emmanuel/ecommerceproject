          ...
          <div class="row row-50 justify-content-center">
            <div class="col-md-10 col-lg-12">
              ...
              <form class="" method="post">
                ...
                $sql = "INSERT INTO checkout (uin, fname, lname, email, `address`, postalcode, city, `state`, company, phone, date) VALUES ('$uin','$fname','$lname','$email', '$address','$postalcode','$city','$state','$company','$phone','$date')";
                ...
                echo "<script>alert('Dear $fname $lname, your order has been successfully placed')
                location.href='cart-page.php'</script>";
}
                ?>
                <div class="row row-14 gutters-14">
                  <input type="hidden" value="<?php echo $rand; ?>" name="uin">
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-first-name-2" type="date" name="date" required>
                  ...
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-first-name-2" type="text" name="fname" required>
                      <label class="form-label" for="checkout-first-name-2">First Name</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-last-name-2" type="text" name="lname" required>
                  ...
                  <div class="col-sm-12">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-email-2" type="email" name="email" required>
                  ...
                  <div class="col-12">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-address-2" type="text" name="address" required>
                      <label class="form-label" for="checkout-address-2">Address</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-postcode-2" type="text" name="postalcode" required>
                      <label class="form-label" for="checkout-postcode-2">Postal Code</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-city-2" type="text" name="city" required>
                      <label class="form-label" for="checkout-city-2">City</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-state-2" type="text" name="state" required>
                      <label class="form-label" for="checkout-state-2">Your State</label>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-phone-2" type="text" name="company" required>
                      <label class="form-label" for="checkout-phone-2">Company</label>
                    </div>
                  </div>
                  <!-- <div class="col-6">
                    <div class="form-wrap">
                      <input class="form-input" id="checkout-company-2" type="text" name="country" required>
                      <label class="form-label" for="checkout-company-2">Country</label>
                    </div>
                  </div> -->
                  <div class="col-sm-6">
                    <div class="">
                      <input class="form-input" id="checkout-phone-2" type="text" name="phone" required>
                      <label class="form-label" for="checkout-phone-2">Phone number</label>
                    </div>
                  </div>
...
?>
                ...
                <td><a class="table-cart-figure"><img src="app/coverphoto/<?php echo $row['coverphoto']; ?>" alt="" width="120" height="100"><?php echo $row['productname'];?></a><a class="table-cart-link"></a></td>
                <td>$<?php echo $row['price'];?></td>
                <td>
                <input style="text-align:center;width:40%; border-width:0px 0px 0px 0px;" type="text" readonly value="<?php echo $row['quantity']; ?>">
                <!-- <input class="form-input" type="number" data-zeros="true" value=""readonly> -->
                </td>
        ...
        <div class="container">
          <div class="row row-50 justify-content-center">
            <div class="col-md-10 col-lg-6">
              ...
              <div class="box-radio" style="height: 80%;">
...
?>
          ...
          <button class="button button-primary"  name="submit">Proceed to checkout</button>
        </form>
      </section>
      <!-- Page Footer-->
