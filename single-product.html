          ...
          <div class="row row-50">
            <div class="col-lg-6">
              <div class="slick-product">
                ...
                <div class="slick-slider carousel-parent" data-swipe="true" data-items="1" data-child="#child-carousel" data-for="#child-carousel">
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-10-530x480.png" alt="" width="530" height="480">
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-11-530x480.png" alt="" width="530" height="480">
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-12-530x480.png" alt="" width="530" height="480">
                    </div>
                  </div>
                </div>
                <div class="slick-slider child-carousel" id="child-carousel" data-for=".carousel-parent" data-arrows="true" data-items="3" data-sm-items="3" data-md-items="3" data-lg-items="3" data-xl-items="3" data-slide-to-scroll="1" data-md-vertical="true">
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-mini-4-169x152.png" alt="" width="169" height="152">
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-mini-5-169x152.png" alt="" width="169" height="152">
                    </div>
                  </div>
                  <div class="item">
                    <div class="slick-product-figure"><img src="images/product-mini-6-169x152.png" alt="" width="169" height="152">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="single-product">
                <h3>CB2 chamber desk</h3>
                <div class="group-md group-middle">
                  <div class="single-product-price">$520.00</div>
                ...
                <p>Designed by an award-winning designer Manuel Saez, this immaculately clean white desktop is the sign of a highly organized, compulsive neatnik. It has space for all your supplies - folders, books, planners, and more!</p>
                <div class="divider divider-30"></div>
                <ul class="list list-description d-inline-block d-md-block">
                  <li><span>Material:</span><span>Birch Plywood</span></li>
                ...
                <div class="group-sm group-middle">
                  ...
                  <div><a class="button button-primary button-pipaluk" href="#">Add to cart</a></div>
                </div>
          ...
          <div class="row row-40 justify-content-center">
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="product">
                ...
                <h5 class="product-title"><a href="single-product.html">CB2 Coup Grey Office Chair</a></h5>
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="product">
                ...
                <h5 class="product-title"><a href="single-product.html">Grasshoppa floor lamp</a></h5>
                <div class="product-price-wrap">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="product">
                ...
                <h5 class="product-title"><a href="single-product.html">Lucinda orange Chair</a></h5>
                <div class="product-price-wrap">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
              ...
              <article class="product">
                ...
                <h5 class="product-title"><a href="single-product.html">Ikea Frode Chair</a></h5>
                <div class="product-price-wrap">
