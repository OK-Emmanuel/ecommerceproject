    ...
    <div class="page">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="blog-post.html">Blog</a>
                        <!-- RD Navbar Dropdown-->
                      </li>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-68">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Services #1</h2>
      ...
      <section class="section section-xl bg-default">
        <div class="container">
          <div class="row row-40">
            ...
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                <div class="box-icon-modern-icon fl-bigmug-line-images21"></div>
                <h5 class="box-icon-modern-title"><a href="single-service.html">Feng shui design</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">With years of experience, our experts can help you design your interior according to the ancient Feng Shui philosophy while saving time.</p>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                <div class="box-icon-modern-icon fl-bigmug-line-foggy3"></div>
                <h5 class="box-icon-modern-title"><a href="single-service.html">Landscape design</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">Our designers will team with you to create your ideal landscape design plan. Their expert advice and solutions will deliver a plan to meet your needs.</p>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                <div class="box-icon-modern-icon fl-bigmug-line-favourites5"></div>
                <h5 class="box-icon-modern-title"><a href="single-service.html">Decorative services</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">Our professional decorators will be happy to help you change your house’s inner look without spending too much money on interior design.</p>
              </article>
            </div>
          </div>
        </div>
