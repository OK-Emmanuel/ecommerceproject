...
<head>
    ...
    <!-- TITLE -->
    <title>ODSBRP Member Table</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title"> search member record result</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Tables</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> search member record result</li>
                                </ol>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title"> search member record result</h3>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom-0">Business type</th>
...
$sql = "SELECT * FROM `register` WHERE businessname LIKE '%$search%' OR phonenumber = '$search' ORDER by `id` DESC";
...
?>  
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['businessservices']; ?></td>
                                                        <td><?php echo $row['ownername']; ?></td>
                                                        <td><?php echo $row['phonenumber']; ?></td>
                                                        <td><img src="/memberlogin/passport/ echo $row['passport']; ?>" height="50" alt=""></td>
                                                    </tr>
                                                    <?php }}
                                                else{
                                                    echo "<script>alert('Ooops! Members record not found')
