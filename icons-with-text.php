  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-43">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Icons with Text</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="../index.html">Home</a></li>
              <li><a href="#">Pages</a></li>
              <li class="active">Icons with Text</li>
            </ul>
          </div>
          <div class="box-position" style="background-image: url(images/bg-icons.jpg);"></div>
        </div>
      </section>
      <!-- Icons #1-->
      <section class="section section-sm section-first bg-default">
        <div class="container">
          <h3>#1</h3>
          <div class="row row-40 box-ordered">
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-creative">
                ...
                <h5 class="box-icon-creative-title"><a href="single-service.html">Focus on our clients</a></h5>
            ...
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-creative">
                ...
                <h5 class="box-icon-creative-title"><a href="single-service.html">Intuitive and easy</a></h5>
            ...
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-creative">
                ...
                <h5 class="box-icon-creative-title"><a href="single-service.html">Non-trivial ideas</a></h5>
            ...
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-creative">
                ...
                <h5 class="box-icon-creative-title"><a href="single-service.html">Full project support</a></h5>
          ...
          <div class="row row-40">
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                ...
                <h5 class="box-icon-modern-title"><a href="single-service.html">Interior design</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">We develop and implement better interior design concepts for you so that you and all your guests could enjoy the unique atmosphere of your home.</p>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                <div class="box-icon-modern-icon fl-bigmug-line-cropping1"></div>
                <h5 class="box-icon-modern-title"><a href="single-service.html">Space planning</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">We create better interior experiences through space planning services. They are vital for a successful interior design project of your home or office.</p>
              </article>
            </div>
            <div class="col-md-6 col-lg-4">
              <article class="box-icon-modern">
                <div class="box-icon-modern-icon fl-bigmug-line-chat55"></div>
                <h5 class="box-icon-modern-title"><a href="single-service.html">Consultations</a></h5>
                <div class="box-icon-modern-decor"></div>
                <p class="box-icon-modern-text">Our specialists are ready to consult you on any interior design related topic. All you have to do is to contact us and we will organize a free consultation.</p>
              </article>
            </div>
          </div>
        </div>
